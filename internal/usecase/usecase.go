...
type EventRepository interface {
	...
	// GetEventsBySensorID - функция получения событий по ID датчика в указанном диапазоне
	GetEventsBySensorID(ctx context.Context, id int64, start, end time.Time) ([]*domain.Event, error)
}
